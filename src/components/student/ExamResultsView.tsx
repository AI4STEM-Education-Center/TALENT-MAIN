    ...
    <div className="space-y-2">
      ...
      {ai.summary ? (
        <>
          ...
          {isPending(ai.summaryStatus) && (
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              <Loader2 className="size-3.5 animate-spin text-primary" /> Writing your summary…
            </div>
          )}
          {ai.summaryStatus === RESULT_STATUS.READY && ai.summaryMetrics && (
            <AiMetricsLine
