    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError(
          typeof body?.error === "string"
            ? body.error
            : `Could not join this class (HTTP ${res.status}).`,
        );
        return;
      }
                              ...
                              {changingEmail && (
                                <div className="space-y-1 pt-2">
                                  ...
                                  {emailMismatch ? (
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      Retype the new address to confirm it.
                                      Class notifications will go here instead
                                      of {rosterEmail}.
                                    </p>
                                  )}
                                  <Button
