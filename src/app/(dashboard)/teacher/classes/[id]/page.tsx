...
export default async function ClassDetailPage({
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      {/* Cards are direct grid children placed explicitly on md+, so same-row boxes
          (Quizzes | Roster and Materials | Invites) stretch to equal heights. On mobile
          they collapse to one column in source order. */}
