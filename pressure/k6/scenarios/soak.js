...
const VUS = studentTarget(Number(__ENV.PRESSURE_SOAK_VUS || 40));
const DURATION = __ENV.PRESSURE_SOAK_DURATION || "2h";
...
export const options = {
  ...
  scenarios: {
    ...
    teachers: {
      executor: "constant-vus",
      exec: "teacher",
      vus: Math.max(1, Math.round(VUS / 20)),
      duration: DURATION,
    },
