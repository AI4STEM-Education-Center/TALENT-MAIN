 ...
 *
 * Usage:
 *   tsx benchmark/tools/mint-sessions.ts --out sessions.json --students 200 --teachers 10
 *   tsx benchmark/tools/mint-sessions.ts --out sessions.json --secure   # __Secure- cookie (prod image)
 */
