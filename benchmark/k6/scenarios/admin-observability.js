...
export const options = {
  ...
  scenarios: {
    ...
    admin: {
      ...
      exec: "admin",
      vus: 1,
      duration: __ENV.BENCH_ADMIN_DURATION || "3m",
    },
    students: {
      executor: "constant-vus",
      exec: "student",
...
export function handleSummary(data) {
  return {
    stdout:
      ...
      `Compare heartbeat static_page p99 here against a run with BENCH_COLLATERAL_STUDENTS=0\n` +
